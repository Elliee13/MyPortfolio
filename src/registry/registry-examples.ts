...
export const examples: Registry["items"] = [
  {
    ...
    registryDependencies: ["@elliee13/apple-hello-effect"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@elliee13/theme-switcher"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@elliee13/wheel-picker", "form"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@elliee13/shimmering-text"],
    files: [
      {
